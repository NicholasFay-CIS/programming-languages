...
val test2a = assoc ("hello", [("hello",20),("foo",19)]) = SOME 20
val test2c = assoc ("hello", [("hi",20),("foo",19)]) = NONE
...
val test7b = count_occurrences (["a", "b"], Fail "") = [("b",1),("a",1)]

val test7c = count_occurrences (["b", "a", "b"], Fail "") = []
             handle (Fail "") => true
...
val test16a = concat_with("-",["c","o","o","l"]) = "c-o-o-l"
val test16b = concat_with("-", []) = ""
val test16c = concat_with("-", ["hello"]) = "hello"

val test17 = quote_string "foo" = "\"foo\""
val test17a = quote_string "dogs" = "\"dogs\""
val test17b = quote_string "Hello World" = "\"Hello World\""

val test18 = real_to_string_for_json ~4.305 = "-4.305"
val test18a = real_to_string_for_json ~5.3 = "-5.3"
val test18b = real_to_string_for_json 10.3 = "10.3"
